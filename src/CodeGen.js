...
// import parser
import flowParser from 'react-native-codegen/lib/parsers/flow/index.js';
// no parser for TS?
// ...?
import fs from 'fs';
...
export type TypeSystem = 'ts' | 'flow';
...
export default function codeGen(
  ...
  let schema;
  if (typeSystem === "flow") {
    schema = flowParser.parseFile(fileInPath);
  } else if (typeSystem === "ts") {
    throw new Error("TypeScript is, unfortunately, not supported yet");
  }
